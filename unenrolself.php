...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'bkash'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/bkash/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_bkash', format_string($course->fullname));
