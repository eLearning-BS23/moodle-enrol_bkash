...
Srequire_once("$CFG->dirroot/enrol/bkash/lib.php");
...
$validation = $DB->get_record('enrol_bkash', array('txn_id' => $_POST['tran_id']));
...
$PAGE->set_title($course->shortname . ': ' . get_string('pluginname', 'enrol_bkash'));
$PAGE->set_heading($course->fullname . ': ' . get_string('pluginname', 'enrol_bkash'));

$PAGE->navbar->add(get_string('course', 'enrol_bkash'), $url);
